...
<?php include('./adminHeader.php')?>
    ...
    <div class="d-flex container-fliud justify-content-center my-5 py-5" > 
           
           
            <div class=" justify-content-center mt-5 p-3 mx-2 " style="border-radius:10px; background-color: var(--board-color); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);">
