...
<div class="w-100 d-flex justify-content-center my-5 py-5 px-2 border border-primary rounded-6 bg-dark">
    <form class="my-3" action="" method="POST">
      ...
      <!-- Submit button -->
      <button data-mdb-ripple-init type="submit" name="submit" class="btn btn-primary btn-block mb-4">Login</button>

      <!-- Register buttons -->
      <div class="text-center text-light">
        <p>Not a member? <a href="./user/register.php">Register</a></p>
        <p>or sign up with:</p>
        <button  data-mdb-ripple-init type="button" class="btn btn-secondary btn-floating m-1">
