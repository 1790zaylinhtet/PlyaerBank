        ...
        <div class="row roboto-serif-bold textColor text-light">
            ...
            <div class="mt-5 navbar-brand  col-md-5">
                <div class="d-flex flex-column">
                    <img src="../images/userPhoto/<?php echo $_SESSION['userPhoto'];?>" height="120" alt="" class=" rounded-circle" />
                ...
                <div class="personalInformation w-100 p-4 form m-auto p-5">
                    ...
                    <form action="#" method="POST" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" name="name"  readonly class="form-control-plaintext text-light BOX" value="<?php echo $_SESSION['username']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="email" name="email" readonly class="form-control-plaintext text-light BOX" value="<?php echo $_SESSION['userEmail']?>">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-3 col-form-label text-light">User ID</label>
                            <div class="col-sm-9">
                              <input type="number" name="id" readonly class="form-control-plaintext text-light" id="userId" value="<?php echo $_SESSION['userid']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="password" name="password" readonly class="form-control-plaintext text-light BOX" value="<?php echo $_SESSION['noUncryptPass']?>">
                            </div>
                        </div>
